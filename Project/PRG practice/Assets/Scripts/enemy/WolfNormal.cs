...
public class WolfNormal : MonoBehaviour
{
    //中狼怪物
    ...
    private GameObject MissTrans;  //要创建的目标物体位置
    ...
    private void Awake()
    {
        ...
        babyexp = 50;
        hp = 200;
        maxdistance_attck =5f;
        mindistance_attack =1.5f;
        //Distance = 5f;
        ...
        Babyrenderer = transform.Find("Wolf_Normal").GetComponent<Renderer>();
