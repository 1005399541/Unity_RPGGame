...
public class WolfBaby : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        babyexp = 20;
        enemyattack = 10;
        maxdistance_attck = 3f;
        mindistance_attack = 2f;
        //Distance = 5f;
        ...
        Babyrenderer=transform.Find("Wolf_Baby").GetComponent<Renderer>();
